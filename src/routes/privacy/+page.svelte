		...
		<div class="prose mx-auto">
			...
			<ul>
				...
				<li>
					<p>
						...
						Agreement) refers to Duke Gulf Company Limited, Saudi Arabia -Riyadh.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						<strong>Website</strong> refers to Duke Gulf, accessible from
						<a href="https://www.dukegulf.com/" rel="external nofollow noopener" target="_blank"
							>https://www.dukegulf.com/</a
						>
					</p>
				</li>
				<li>
			...
			<ul>
				...
				<li>
					...
					opened an email and for other related website statistics (for example, recording the popularity
			...
			<ul>
				...
				<li>
					...
					profile, pictures and description of Your activity. Similarly, other users will be able to
			...
			<ul>
				<li>
					<p>By email: Dukegulf@hotmail.com</p>
				</li>
				<li>
					<p>By phone number: +966539040070</p>
				</li>
			</ul>
		</div>
	</div>
